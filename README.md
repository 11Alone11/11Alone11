...
Магазин велосипедов в Минске, написан польностью с нуля на Nuxt 3.
после редизайна старой версии сайта.

### 📌 [Beerzhevik](https://app.beerzhevik.ru/banners/)

Платформа для интерастивного отображения изменения цен на позиции в баре.
Разработано удобное веб-приложение для официантов и посетителей бара.
